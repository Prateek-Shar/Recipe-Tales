    ...
    return (
        ...
        <>
            <div className="w-full flex flex-col justify-center items-center">
                ...
                {showStats && (
                    <p className="font-Capra xl:text-4xl mm:text-2xl mt-15 text-center">{Meal_name}</p>
                )}
                    ...
                    <div className="w-full flex xl:flex-row mm:flex-col xl:justify-evenly mm:items-center xl:items-start mt-20">
                        <div className="xl:w-[40%] mm:w-[90%] flex flex-col justify-center">
                            <div className="xl:w-full flex xl:ml-0 mm:ml-1 items-center mm:mb-3 xl:mb-0">
                                <Image src={ing} alt="ing" className="mm:h-8 mm:w-9 xl:w-12 xl:h-12" />    
                                <p className="font-Mogra text-3xl xl:ml-5 mm:ml-3">Ingredients</p>
                            </div>

                            {mealDet?.Ingredient.map((ing, index) => (
                                <div key={index} className="flex xl:mt-6 mm:mt-4">
                                    <Image src={ut} alt="Ing Icon" className="xl:p-1 mm:p-2 mm:h-10 mm:w-10 xl:h-9 xl:w-10"/>
                                    <p key={index} className="font-Poppins p-2 xl:ml-3 mm:ml-0 xl:text-[20px] mm:text-[16px] bg-[#fffbeb] w-[90%] rounded-2xl">{ing}</p>
                                </div>
                            ))}
                        </div>  
                        ...
                        <div className="xl:w-[40%] mm:w-[90%] xl:mt-0 mm:mt-20">
                            ...
                            {mealDet?.Instructions.map((ins, index) => (
                                <div key={index}>
                                    ...
                                    <p key={index} className="font-Poppins p-2 xl:text-[20px] mm:text-[16px] bg-[#fffbeb] w-[90%] rounded-2xl">{ins}</p>
                                    </div>
                                </div>
                            ))}
                        </div>  
                    ...
                    <div className="w-[85%] bg-white my-20 rounded-2xl">
                        ...
                        <div className="flex xl:flex-row mm:flex-col mt-8">
                            <div className="xl:w-[20%] mm:w-[90%] flex p-2">
                                <p className="font-Capra xl:text-2xl mm:text-[18px] text-stone-800">Prep Time : </p>
                                <p className="font-Poppins xl:text-[22px] mm:text-[18px] pl-2"> {mealDet?.Prep_Time || "NA"} mins</p>
                            </div>

                            <div className="xl:w-[20%] mm:w-[90%] flex p-2">
                                <p className="font-Capra xl:text-2xl mm:text-[18px] text-stone-800">Cook Time - </p>
                                <p className="font-Poppins xl:text-[22px] mm:text-[18px] pl-2">{mealDet?.Cook_Time || "NA"} mins</p>
                            </div>

                            <div className="xl:w-[20%] mm:w-[90%] flex p-2">
                                <p className="font-Capra xl:text-2xl mm:text-[18px] text-stone-800">Servings - </p>
                                <p className="font-Poppins xl:text-[22px] mm:text-[18px] pl-2">{mealDet?.Servings}</p>
                            </div>
                        </div>

                        <div className="flex">
                            <div className="xl:w-[20%] mm:w-[90%] flex p-2">
                                <p className="font-Capra xl:text-2xl mm:text-[18px] text-stone-800">Tags - </p>
                                {mealDet?.Tags.map((tg , idx) => (
                                    <p key={idx} className="font-Poppins xl:text-[22px] mm:text-[18px] pl-2">{tg}</p>
                                ))} 
                            </div>
                        </div>
                        ...
                        <div className="flex">
                            <div className="xl:w-[20%] mm:w-[90%] flex p-2">
                                <p className="font-Capra xl:text-2xl mm:text-[18px] text-stone-800">Recipe Of - </p>
                                <p className="font-Poppins xl:text-[22px] mm:text-[18px] pl-2">{mealDet?.Author_name}</p>
                            </div>
                        </div>
                    </div>
                )}
