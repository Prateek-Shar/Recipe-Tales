    ...
    <div className="flex flex-col mm:relative">
      ...
      <div className="w-full flex flex-col xl:justify-center items-center">
        ...
        {/* <div className="xl:w-[30%] mm:w-[80%] flex justify-center items-center mt-5">
          ...
          <p className="font-Capra mm:text-[13px] xl:text-[16px] ml-2 pt-1">Categories coming soon</p>
        </div> */}
      ...
      <div className="w-full bg-[#f2f1ff] flex flex-col mt-10">
        ...
        <div className="w-full flex flex-col justify-center items-center my-5">
          ...
          <div className="xl:w-[30%] mm:w-[80%] flex justify-center items-center mt-8">
            ...
            <p className="font-Capra mm:text-[13px] xl:text-[16px] ml-2 pt-1">This feature is currently under developement</p>
            </div>
          </div>
        </div>
