...
const Catagory_Cards = () => {
    ...
    return (
        <>
            ...
            <div className="xl:w-[15%] mm:w-[17%] bg-[#f2f1ff] border-2 border-[#eeeeee] rounded-4xl hover:cursor-pointer">
            ...
            <div className="w-[15%] bg-[#f2f1ff] border-2 border-[#eeeeee] rounded-4xl hover:cursor-pointer">
                <div className="w-full xl:p-4 xl:mt-0 mm:p-1 flex justify-center mm:mt-2">
                    <Image src={dinner} alt="breakfast" className="object-contain xl:w-[30%] mm:w-[40%]"/>
                </div>
            ...
            <div className="w-[15%] bg-[#f2f1ff] border-2 border-[#eeeeee] rounded-4xl hover:cursor-pointer">
                ...
                <div className="w-full flex justify-center xl:mb-2 xl:my-0 mm:my-1">
